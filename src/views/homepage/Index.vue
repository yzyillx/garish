...
export default {
  ...
  mounted() {
    const chartDom=this.$refs['clock']
    ...
    let updateSeries=(time, series, type) =>{
    ...
    setInterval(() =>{
      ...
      updateSeries(second, this.option.series[2], 'second');
      updateSeries(minute, this.option.series[1], 'minute');
      updateSeries(hour, this.option.series[0], 'hour');
